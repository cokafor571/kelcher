...
function starterpack_setup() {
    ...
    // Add theme support for video headers.
...
/** 
*
* Add mime type for uploading svg
*
**/ 
...
function starterpack_scripts() {
	...
	*
	...
	wp_enqueue_script( 'starterpack-navigation', get_template_directory_uri() . '/js/navigation.min.js', array( 'jquery' ), '20180503', true );
	...
	*/
    ...
    if ( is_front_page() ) {
        wp_enqueue_script( 'starterpack-scroll-script', get_template_directory_uri() . '/js/scroll-scripts.js', array(), '20180503', true );
    }
